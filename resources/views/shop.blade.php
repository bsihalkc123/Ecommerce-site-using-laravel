...
@section('content')
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="page size" id="page-size" name="page-size" style="margin-right: 20px;">
  ...
  <form id="frmfilter" method="GET" action="{{route('shop.index')}}">
    ...
    <input type="hidden" id="hdnminprice" name="min_price" value="{{ $min_price ?? 1 }}">
    <input type="hidden" id="hdnmaxprice" name="max_price" value="{{ $max_price ?? 2000 }}">
  </form>
@endsection
@push('scripts')
<script>
...
$(document).ready(function () {
  ...
  let priceSlider = $('.price-range-slider').slider({
    min: 1,
    max: 2000,
    step: 5,
    value: [
      parseInt($('#hdnminprice').val()),
      parseInt($('#hdnmaxprice').val())
    ],
    tooltip: 'hide'
  });
