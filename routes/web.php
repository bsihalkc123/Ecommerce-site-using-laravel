...
Route::middleware(['auth', AuthAdmin::class])->group(function () {
    ...
    Route::get('/admin/product/view/{id}', [AdminController::class, 'product_view'])->name('admin.product.view');
    //Coupons Routes for Admin
